    ...
    <AppBar className={classes.component}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <Typography variant="h4" style={{marginRight:70,marginLeft:-90}} noWrap component="div" sx={{ mr: 2, display: { xs: 'none', md: 'flex' } }}>
      <Link to='/' style={{textDecoration:'none'}}>Fashion Gallery 786</Link>  
          </Typography>
